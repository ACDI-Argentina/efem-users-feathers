...
const { AdminAbi } = require("@acdi/efem-contract"); 
const { network,
    ADMIN_CONTRACT_ADDRESS,
    AVALDAO_CONTRACT_ADDRESS } = require("../../../config/config");

const provider = new Web3.providers.HttpProvider(network.url);
const web3 = new Web3(provider);

const adminContract = new web3.eth.Contract(AdminAbi, ADMIN_CONTRACT_ADDRESS);
